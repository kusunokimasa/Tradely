...
# LOGO ADDED HERE!
st.sidebar.image("tradely-logo.png", use_container_width=True)
...
# ==================== ADD TRADE PAGE ====================
    ...
    with col2:
        ...
        strategy_option = st.selectbox("Strategy", ["Custom"] + st.session_state.custom_strategies)
        ...
        for week in month_days:
            ...
            for i, day in enumerate(week):
                if day == 0:
                    ...
                    day_data = daily_summary[daily_summary['Day'] == custom strategy"""
    if new_strategy and new_strategy not in st.session_state.custom_strategies:
        st.session_state.custom_strategies.append(new_strategy)
        save_strategies()
        return True
